...
class BackApplicationTests3_Service {
	...
	// ---------------------------------------------------------------------
	@Test
	@DisplayName("■ CommentSevice-CRUD ")
	void testCommentSevice() {
		// 댓글 작성
    ...
    void testRetweetService() { 
        ...
        assertThat(retweet.getRetweetCount()).isEqualTo(1); // 리트윗수 1개야
        // 중복리트윗 -> 예외
