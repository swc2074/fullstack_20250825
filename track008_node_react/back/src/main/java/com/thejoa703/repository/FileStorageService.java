...
public class FileStorageService {
    ...
    public String upload(MultipartFile file) {
        try {
            ...
            Path target = root.resolve(filename); // uploads 디렉토리안에 filename 붙여서 최종 저장경로 생성
            Files.copy(file.getInputStream(), target, StandardCopyOption.REPLACE_EXISTING); // 파일 복사
