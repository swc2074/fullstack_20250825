...
public class JavaIO005_buffered {
	...
	public static void main(String[] args) throws IOException {
		...
		String file_path = 
				"io005" + today.get(1) + (today.get(2)+1) +today.get(5) + ".txt";
		//  				          년 				월					일
		...
		System.out.println(">1.폴더+파일 준비완료 !");
				...
				//#3. 파일 쓰기             InputStream  > [프로그램] > OutputSteam #
		//BufferedWriter(속도향상) -  OutputStreamWriter(단어) - FileOutStream(byte)
		...
		System.out.println(">2. 쓰기완료");
				...
				//#4. 파일 읽기              InputStream # > [프로그램] > OutputSteam 
