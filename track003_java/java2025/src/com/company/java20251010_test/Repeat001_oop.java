...
// 이번클래스의 의미는?   커피를 만들고 보여주는 놀이  - 3단계 
//1. 클래스는 부품객체
...
{name="아메"    , num=1,price=2000 / show()}	     ←  a2(2000번지)         @31번째줄 	
___________________________________________________________________________________
												 ←  a1(1000번지).show()  @30번째줄 
1000번지	
{name="까페라떼", num=2,price=4000 / show()}	     ←  a1(1000번지)  @28번째줄(a1 실제로 만든 장난감,객체,인스턴스)
   										   			a1(null)     @27번째줄
									   			|   main 	  ★
------------------------------------------------------------
*/
