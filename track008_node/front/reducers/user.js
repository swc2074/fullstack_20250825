 ...
 */
 ...
 export const SIGN_UP_REQUEST = 'SIGN_UP_REQUEST'; // 로그인 요청
 export const SIGN_UP_SUCCESS = 'SIGN_UP_SUCCESS'; // 로그인 성공
 export const SIGN_UP_FAILURE = 'SIGN_UP_FAILURE'; // 로그인 실패

 export const LOAD_USERS_REQUEST = 'LOAD_USERS_REQUEST'; // 로그인 요청
 export const LOAD_USERS_SUCCESS = 'LOAD_USERS_SUCCESS'; // 로그인 성공
 export const LOAD_USERS_FAILURE = 'LOAD_USERS_FAILURE'; // 로그인 실패

 export const UPDATE_NICKNAME_REQUEST = 'UPDATE_NICKNAME_REQUEST'; // 로그인 요청
 export const UPDATE_NICKNAME_SUCCESS = 'UPDATE_NICKNAME_SUCCESS'; // 로그인 성공
 export const UPDATE_NICKNAME_FAILURE = 'UPDATE_NICKNAME_FAILURE'; // 로그인 실패

 export const DELETE_USER_REQUEST = 'DELETE_USER_REQUEST'; // 로그인 요청
 export const DELETE_USER_SUCCESS = 'DELETE_USER_SUCCESS'; // 로그인 성공
 export const DELETE_USER_FAILURE = 'DELETE_USER_FAILURE'; // 로그인 실패
