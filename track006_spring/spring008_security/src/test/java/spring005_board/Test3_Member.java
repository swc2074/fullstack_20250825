...
public class Test3_Member {
	...
	@Autowired  @Qualifier("passwordEncoder") PasswordEncoder pwencorder;
...
//		System.out.println(dao.insertAuth(adto));
		...
		//2. 회원 가입 1@1 1/ 2@2 2 / 3@3  3
//		AppUserDto dto = new AppUserDto();  
//		dto.setEmail("3@3"); dto.setPassword(pwencorder.encode("3")); dto.setMbtiTypeId(1);
