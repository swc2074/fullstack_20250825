...
public class AppUserSecurityController {
	...
	@RequestMapping(value="/join"  , method=RequestMethod.POST , headers=("content-type=multipart/*"))// 회원가입기능
	...
	public String mypage(Principal pricipal , Model model) {
				model.addAttribute("dto",service.selectEmail(pricipal.getName()));
...
//	public String update(AppUser dto, RedirectAttributes rttr, Principal principal) {
//	    
//	    // 로그인한 사용자 아이디를 DTO에 세팅
...
//	}
	...
	public String delete(Principal principal, AppUser dto, RedirectAttributes rttr
